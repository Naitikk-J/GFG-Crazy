  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cameraPositions = [
        { x: 0, y: 30, z: 300 },    // Section 0 - GEEKSFORGEEKS
        { x: 0, y: 40, z: -50 },     // Section 1 - LEARN
        { x: 0, y: 50, z: -700 }       // Section 2 - PRACTICE
      ];
  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: 'hidden' }}>
        ...
        <div className="vertical-text">GFG</div>
      </div>
      ...
      <div className="scroll-sections">
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles = {
            0: {
              line1: 'A Computer Science portal for geeks',
              line2: 'Learn, Practice, and Master Programming'
            },
            1: {
              line1: 'Data Structures, Algorithms, and More',
              line2: 'From basics to advanced concepts'
            },
            2: {
              line1: 'Coding problems and programming challenges',
              line2: 'Build your skills with real-world practice'
            }
          };
